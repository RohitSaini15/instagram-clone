...
export default function Modal() {
  ...
  return (
    <Transition.Root show={open} as={Fragment}>
      ...
      >
        <div className="flex items-end justify-center min-h-[800px] s:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          <Transition.Child
            as={Fragment}
              ...
              <div>
                {selectedFile ? (
                  <img
                    src={selectedFile}
                    alt=""
                    className="w-full obect-contain cursor-pointer"
